...
import { ArrowLeft, FileText, Download, Upload, Loader2, X, AlertCircle } from 'lucide-react';
...
export default function DocxToPdfPage() {
    ...
    const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
        if (e.target.files && e.target.files[0]) {
            ...
            if (file.name.endsWith('.docx') || file.name.endsWith('.doc')) {
                ...
                setError('File harus format .docx atau .doc');
            }
        }
    };
    ...
    const handleConvert = async () => {
        ...
        try {
            ...
            if (!response.ok) {
                throw new Error('Gagal konversi DOCX ke PDF');
            }
            ...
            setError(err instanceof Error ? err.message : 'Gagal konversi DOCX');
        } finally {
    ...
    const handleDownload = () => {
        ...
        a.href = pdfUrl;
        a.download = selectedFile?.name.replace(/\.(docx|doc)$/i, '.pdf') || 'converted.pdf';
            ...
            <div className="max-w-4xl mx-auto px-4 pt-24 pb-16">
                ...
                <div className="text-center mb-8 opacity-0 animate-[slideUp_0.6s_ease-out_forwards]">
                    ...
                    <p className="text-xl text-gray-600">
                        Konversi dokumen Word jadi PDF
                    </p>
                </div>
                        ...
                        <div className="border-2 border-dashed border-red-200 rounded-2xl p-12 text-center bg-gradient-to-br from-red-50/50 to-transparent hover:border-red-300 transition-colors cursor-pointer">
                            ...
                            <label htmlFor="file-upload" className="cursor-pointer">
                                ...
                                <p className="text-gray-600 mb-4">
                                    Upload file Word (.docx atau .doc)
                                </p>
                ...
                {pdfUrl && !isProcessing && (
                    <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-12 text-center opacity-0 animate-[fadeIn_0.4s_ease-out_forwards]">
                        ...
                        <p className="text-gray-600 mb-8">
                            DOCX udah jadi PDF, ready untuk download
                        </p>
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="text-center p-6 bg-white rounded-2xl border border-gray-100 shadow-sm">
                        ...
                        <p className="text-sm text-gray-600">Support .doc dan .docx</p>
                    </div>
                    <div className="text-center p-6 bg-white rounded-2xl border border-gray-100 shadow-sm">
                        <div className="text-3xl mb-2">🎨</div>
                        <h4 className="font-semibold text-gray-900 mb-1">Jaga Layout</h4>
                        <p className="text-sm text-gray-600">Format tetep rapi</p>
                    </div>
                    <div className="text-center p-6 bg-white rounded-2xl border border-gray-100 shadow-sm">
                        <div className="text-3xl mb-2">✨</div>
