...
import { ArrowLeft, ImagePlus, Download, X, Upload, Loader2 } from 'lucide-react';
...
export default function JpgToPdfPage() {
    ...
    const handleConvert = async () => {
        ...
        try {
            ...
            // Convert using client-side pdf-lib
            ...
            setError(err instanceof Error ? err.message : 'Gagal mengkonversi gambar');
        } finally {
            ...
            <div className="max-w-4xl mx-auto px-4 pt-24 pb-16">
                ...
                <div className="text-center mb-12 opacity-0 animate-[slideUp_0.6s_ease-out_forwards]">
                    ...
                    <p className="text-xl text-gray-600">
                        Gabung gambar jadi satu file PDF rapi
                    </p>
                </div>
                ...
                {isProcessing && (
                    <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-12 text-center opacity-0 animate-[fadeIn_0.4s_ease-out_forwards]">
                        ...
                        <p className="text-gray-600 mb-6">
                            Sabar ya, lagi gabungin gambar kamu
                        </p>
                ...
                {pdfResult && !isProcessing && (
                    <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-12 text-center opacity-0 animate-[fadeIn_0.4s_ease-out_forwards]">
                        ...
                        <p className="text-gray-600 mb-8">
                            PDF kamu sudah ready untuk download
                        </p>
