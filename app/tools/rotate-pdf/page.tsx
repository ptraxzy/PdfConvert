...
import { ArrowLeft, RotateCw, Download, Upload, Loader2, X, RotateCcw } from 'lucide-react';
...
export default function RotatePdfPage() {
    ...
    const handleRotate = async () => {
        ...
        try {
            ...
            const pdfBytes = await rotatePdf(selectedFile, rotation);
            ...
            setError(err instanceof Error ? err.message : 'Gagal putar PDF');
        } finally {
            ...
            <div className="max-w-4xl mx-auto px-4 pt-24 pb-16">
                ...
                <div className="text-center mb-12 opacity-0 animate-[slideUp_0.6s_ease-out_forwards]">
                    ...
                    <p className="text-xl text-gray-600">
                        Putar halaman PDF kamu sesuai kebutuhan
                    </p>
                </div>

                {!rotatedPdf && !isProcessing && (
                        ...
                        <div className="mb-6">
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                ...
                                >
                                    ...
                                    <p className="text-xs text-gray-600">Kanan</p>
                                </button>
                                <button
                                ...
                                >
                                    <div className="w-8 h-8 mx-auto mb-2 flex items-center justify-center">
                                        <RotateCw className="w-8 h-8 text-red-600" style={{ transform: 'rotate(180deg)' }} />
                                    </div>
                                    <p className="font-semibold text-gray-900">180°</p>
                                    <p className="text-xs text-gray-600">Terbalik</p>
                                </button>
                                <button
                                ...
                                >
                                    ...
                                    <p className="font-semibold text-gray-900">270°</p>
                                    <p className="text-xs text-gray-600">Kiri</p>
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="border-2 border-dashed border-red-200 rounded-2xl p-12 text-center bg-gradient-to-br from-red-50/50 to-transparent hover:border-red-300 transition-colors cursor-pointer">
                            ...
                            <label htmlFor="file-upload" className="cursor-pointer">
                                ...
                                <p className="text-gray-600 mb-4">
                                    Upload file PDF yang mau diputar
                                </p>
                ...
                {rotatedPdf && !isProcessing && (
                    <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-12 text-center opacity-0 animate-[fadeIn_0.4s_ease-out_forwards]">
                        ...
                        <p className="text-gray-600 mb-8">
                            PDF udah dirotate {rotation}°, ready untuk download
                        </p>
